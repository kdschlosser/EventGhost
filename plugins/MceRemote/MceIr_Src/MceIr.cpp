...
static BOOL MceIrImportProntoRC5(PUCHAR pData, ULONG Length, PUCHAR *pBuf, PULONG pReadCount)
{
    ...
    if (Length < 20)
        return FALSE;
    if (sscanf_s((PCHAR)pData, "%04x %04x %04x %04x", (UINT *)&Proto, (UINT *)&Clock, (UINT *)&Seq1, (UINT *)&Seq2) != 4)
        return FALSE;
    ...
    pData += 20;
    if (sscanf_s((PCHAR)pData, "%04x %04x", (UINT *)&System, (UINT *)&Command) != 2)
        return FALSE;
    if (System > 31)
        return FALSE;
    if (Command > 127)
...
static BOOL MceIrImportProntoRC5X(PUCHAR pData, ULONG Length, PUCHAR *pBuf, PULONG pReadCount)
{
    ...
    do
    {
        ...
        pData += 20;
        if (sscanf_s((PCHAR)pData, "%04x %04x %04x", (UINT *)&System, (UINT *)&Command, (UINT *)&Data) != 3)
            break;
        if (System > 31) 
            break;
        if (Command > 127) 
...
static BOOL MceIrImportProntoRC6(PUCHAR pData, ULONG Length, PUCHAR *pBuf, PULONG pReadCount)
{
    ...
    do
    {
        //Read 15 bytes of header
        if (Length < 20) break;
        if (sscanf_s((PCHAR)pData, "%04x %04x %04x %04x", (UINT *)&Proto, (UINT *)&Clock, (UINT *)&Seq1, (UINT *)&Seq2) != 4) break;
        if (Proto != PRONTO_PROTO_RC6) break;
        if (Seq1 + Seq2 != 1) break;

        pData += 20;
        if (sscanf_s((PCHAR)pData, "%04x %04x", (UINT *)&System, (UINT *)&Command) != 2) break;
        if (System > 255) break;
...
static BOOL MceIrImportProntoRC6A(PUCHAR pData, ULONG Length, PUCHAR *pBuf, PULONG pReadCount)
{
    ...
    do
    {
        ...
        pData += 20;
        if (sscanf_s((PCHAR)pData, "%04x %04x %04x", (UINT *)&Customer, (UINT *)&System, (UINT *)&Command) != 3) break;
        if (System > 255) break;
        if (Command > 255) break;
...
static BOOL MceIrImportProntoLearned(PUCHAR pData, ULONG Length, PUCHAR *pBuf, PULONG pReadCount)
{
    ...
    do
    {
        ...
        if (sscanf_s(pHeader, " %04x %04x %04x", (UINT *)&Clock, (UINT *)&Seq1, (UINT *)&Seq2) != 3) break;
        if (Clock == 0) break;
        ...
        *pReadCount = 0;
        ...
        for(;;)
        {
            ...
            if (!Remaining)
            {
                ...
                if (sscanf_s((PCHAR)pPronto, " %04x", (UINT *)&Remaining) != 1)  break;
                Seq--;
